...
def listar_servico(request):
    if request.method == "GET":
        servicos_qs = Servico.objects.all().order_by('-data_inicio')
        # pagination
        ...
        return render(request, 'listar_servico.html', {'servicos': servicos, 'paginator': paginator})
...
def agenda(request):
    # Placeholder view para Agenda
    return render(request, 'agenda.html')


def historico(request):
    # Placeholder view para Histórico
